...
export default function FAQ() {
    ...
    return (
        <section className="container py-12">
            <h3 className="text-xl md:text-2xl font-semibold mb-4">FAQs</h3>
            <div className="rounded-2xl border border-brand-border divide-y divide-zinc-800/60 overflow-hidden">
                {faqs.map((f, i) => (
                    <details key={i} open={open === i} onClick={() => setOpen(open === i ? null : i)} className="bg-black/20">
